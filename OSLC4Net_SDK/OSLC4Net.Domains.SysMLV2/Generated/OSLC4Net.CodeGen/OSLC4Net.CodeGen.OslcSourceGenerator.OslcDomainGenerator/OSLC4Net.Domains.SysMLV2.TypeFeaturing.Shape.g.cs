...
[OslcResourceShape(title = "TypeFeaturingShape", describes = new string[] { "https://www.omg.org/spec/sysml/vocabulary#TypeFeaturing" })]
public partial record TypeFeaturing : Relationship, ITypeFeaturing
{
    ...
    [OslcOccurs(Occurs.ExactlyOne)]
    [OslcPropertyDefinition("https://www.omg.org/spec/sysml/vocabulary#featureOfType")]
    ...
    [OslcOccurs(Occurs.ZeroOrOne)]
    [OslcPropertyDefinition("https://www.omg.org/spec/sysml/vocabulary#owningFeatureOfType")]
