...
public partial interface ISatisfyRequirementUsage : IAssertConstraintUsage, IRequirementUsage
{
}
...
public partial record SatisfyRequirementUsage : AssertConstraintUsage, ISatisfyRequirementUsage
{
    ...
    public new Uri AssertedConstraint { get; set; } = null!;
    ...
    [OslcReadOnly(false)]
    [OslcTitle("isNegated")]
    public new string IsNegated { get; set; } = string.Empty;
    ...
    [OslcDescription("The <code>RequirementUsage</code> that is satisfied by the <code>satisfyingSubject</code> of this <code>SatisfyRequirementUsage</code>. It is the <code>assertedConstraint</code> of the <code>SatisfyRequirementUsage</code> considered as an <code>AssertConstraintUsage</code>, which must be a <code>RequirementUsage</code>.")]
    [OslcOccurs(Occurs.ExactlyOne)]
    [OslcPropertyDefinition("https://www.omg.org/spec/sysml/vocabulary#satisfiedRequirement")]
    [OslcName("satisfiedRequirement")]
    [OslcValueType(ValueType.Resource)]
    [OslcRepresentation(Representation.Either)]
    [OslcRange("https://www.omg.org/spec/sysml/vocabulary#RequirementUsage")]
    [OslcReadOnly(false)]
    [OslcTitle("satisfiedRequirement")]
    public Uri SatisfiedRequirement { get; set; } = null!;
    ...
    [OslcDescription("The <code>Feature</code> that represents the actual subject that is asserted to satisfy the <code>satisfiedRequirement</code>. The <code>satisfyingFeature</code> is bound to the <code>subjectParameter</code> of the <code>SatisfyRequirementUsage</code>.")]
    [OslcOccurs(Occurs.ExactlyOne)]
    [OslcPropertyDefinition("https://www.omg.org/spec/sysml/vocabulary#satisfyingFeature")]
    [OslcName("satisfyingFeature")]
    [OslcValueType(ValueType.Resource)]
    [OslcRepresentation(Representation.Either)]
    [OslcRange("https://www.omg.org/spec/sysml/vocabulary#Feature")]
    [OslcReadOnly(false)]
    [OslcTitle("satisfyingFeature")]
    public Uri SatisfyingFeature { get; set; } = null!;
