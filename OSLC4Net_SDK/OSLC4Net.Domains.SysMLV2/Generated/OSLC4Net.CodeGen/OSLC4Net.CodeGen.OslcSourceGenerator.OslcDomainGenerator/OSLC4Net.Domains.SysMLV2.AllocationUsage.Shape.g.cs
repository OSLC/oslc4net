...
public partial record AllocationUsage : ConnectionUsage, IAllocationUsage
{
    ...
    public new HashSet<Uri> ConnectionDefinition { get; set; } = new(OslcUriEqualityComparer.Instance);
    ...
    public new HashSet<Uri> ItemDefinition { get; set; } = new(OslcUriEqualityComparer.Instance);
    ...
    public new HashSet<Uri> PartDefinition { get; set; } = new(OslcUriEqualityComparer.Instance);
