...
public partial record InterfaceDefinition : ConnectionDefinition, IInterfaceDefinition
{
    ...
    public new HashSet<Uri> AssociationEnd { get; set; } = new(OslcUriEqualityComparer.Instance);


    [OslcDescription("The <code>Usages</code> that define the things related by the <code>ConnectionDefinition</code>.")]
    [OslcOccurs(Occurs.ZeroOrMany)]
    [OslcPropertyDefinition("https://www.omg.org/spec/sysml/vocabulary#connectionEnd")]
    [OslcName("connectionEnd")]
    [OslcValueType(ValueType.Resource)]
    [OslcRepresentation(Representation.Either)]
    [OslcRange("https://www.omg.org/spec/sysml/vocabulary#Usage")]
    [OslcReadOnly(false)]
    [OslcTitle("connectionEnd")]
    public new HashSet<Uri> ConnectionEnd { get; set; } = new(OslcUriEqualityComparer.Instance);
    ...
    public new HashSet<Uri> RelatedType { get; set; } = new(OslcUriEqualityComparer.Instance);
    ...
    [OslcReadOnly(false)]
    [OslcTitle("source")]
    public new HashSet<Uri> Source2 { get; set; } = new(OslcUriEqualityComparer.Instance);
    ...
    public new Uri? SourceType { get; set; }
    ...
    public new HashSet<Uri> TargetType { get; set; } = new(OslcUriEqualityComparer.Instance);
