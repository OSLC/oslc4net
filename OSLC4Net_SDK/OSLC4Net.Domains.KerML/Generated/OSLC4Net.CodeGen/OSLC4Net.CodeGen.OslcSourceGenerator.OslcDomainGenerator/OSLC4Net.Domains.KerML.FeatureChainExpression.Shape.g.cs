...
public partial record FeatureChainExpression : OperatorExpression, IFeatureChainExpression
{
    ...
    [OslcOccurs(Occurs.ZeroOrMany)]
    [OslcPropertyDefinition("https://www.omg.org/spec/kerml/vocabulary#argument")]
    [OslcName("argument")]
    ...
    [OslcOccurs(Occurs.ExactlyOne)]
    [OslcPropertyDefinition("https://www.omg.org/spec/kerml/vocabulary#instantiatedType")]
    ...
    [OslcReadOnly(false)]
    [OslcTitle("operator")]
    public new string Operator { get; set; } = string.Empty;
