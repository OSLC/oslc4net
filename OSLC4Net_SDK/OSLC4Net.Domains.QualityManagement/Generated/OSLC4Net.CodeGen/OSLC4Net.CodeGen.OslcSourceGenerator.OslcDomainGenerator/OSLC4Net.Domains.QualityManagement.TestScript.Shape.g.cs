...
public partial interface ITestScript : IExtendedResource
{
}
...
public partial record TestScript : AbstractResourceRecord, ITestScript
{
    ...
    public HashSet<Uri> ExecutionInstructions { get; set; } = new(OslcUriEqualityComparer.Instance);
    ...
    [OslcDescription("Requirement that is validated by the Test Script. It is likely that the target resource will be an oslc_rm:Requirement but that is not necessarily the case.")]
    [OslcOccurs(Occurs.ZeroOrMany)]
