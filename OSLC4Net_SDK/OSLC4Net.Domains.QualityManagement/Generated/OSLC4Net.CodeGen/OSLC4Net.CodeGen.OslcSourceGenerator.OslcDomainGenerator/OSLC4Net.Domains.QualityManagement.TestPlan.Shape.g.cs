...
public partial interface ITestPlan : IExtendedResource
{
}
...
public partial record TestPlan : AbstractResourceRecord, ITestPlan
{
    ...
    public HashSet<Uri> RunsOnTestEnvironment { get; set; } = new(OslcUriEqualityComparer.Instance);
    ...
    [OslcOccurs(Occurs.ZeroOrMany)]
    [OslcPropertyDefinition("http://open-services.net/ns/qm#usesTestCase")]
    ...
    public HashSet<Uri> UsesTestCase { get; set; } = new(OslcUriEqualityComparer.Instance);
    ...
    public HashSet<Uri> ValidatesRequirementCollection { get; set; } = new(OslcUriEqualityComparer.Instance);
