...
public partial interface ITestResult : IExtendedResource
{
}

[OslcNamespace("http://open-services.net/ns/qm#")]
[OslcResourceShape(title = "QM Test Result", describes = new string[] { "http://open-services.net/ns/qm#TestResult" })]
public partial record TestResult : AbstractResourceRecord, ITestResult
{
    ...
    public HashSet<Uri> AffectedByChangeRequest { get; set; } = new(OslcUriEqualityComparer.Instance);
    ...
    public Uri? ExecutesTestScript { get; set; }
    ...
    public Uri? ProducedByTestExecutionRecord { get; set; }
    ...
    public Uri ReportsOnTestCase { get; set; } = null!;
    ...
    public Uri? ReportsOnTestPlan { get; set; }
    ...
    public Uri? RunsOnTestEnvironment { get; set; }
