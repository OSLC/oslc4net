...
public partial interface ITestExecutionRecord : IExtendedResource
{
}
...
public partial record TestExecutionRecord : AbstractResourceRecord, ITestExecutionRecord
{
    ...
    public HashSet<Uri> BlockedByChangeRequest { get; set; } = new(OslcUriEqualityComparer.Instance);
    ...
    [OslcDescription("Test Script executed by the Test Execution Record. It is likely that the target resource will be an oslc_qm:TestScript but that is not necessarily the case.")]
    [OslcOccurs(Occurs.ZeroOrOne)]
    ...
    public Uri RunsTestCase { get; set; } = null!;
