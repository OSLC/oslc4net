...
public partial interface IChangeRequest : IExtendedResource
{
}
...
public partial record ChangeRequest : AbstractResourceRecord, IChangeRequest
{
    ...
    [OslcDescription("Tracks the associated Requirement or Requirement ChangeSet resources. It is likely that the target resource will be an <code>oslc_rm:Requirement</code> but that is not necessarily the case.")]
    [OslcOccurs(Occurs.ZeroOrMany)]
    ...
    [OslcRepresentation(Representation.Reference)]
    [OslcRange("http://open-services.net/ns/rm#Requirement")]
    [OslcTitle("Tracks Requirement")]
    public HashSet<Uri> TracksRequirement { get; set; } = new(OslcUriEqualityComparer.Instance);
