...
*   Use ISO verbal forms to easily identify requirements, recommendations, permissions, possibility and capability and external constraints in the text. Alternative expressions are not always easily understood in place of the ISO verbal forms. See [ISO/IEC Directives, Part 2, 2021, Clause 7](https://www.iso.org/sites/directives/current/part2/index.xhtml#_idTextAnchor078 "ISO/IEC Directives, Part 2, 2021, Clause 7").
...
[Back to browsing](#iso-hs-s-browsing)
...
When the collective noun is followed by a [non-defining relative clause](#iso-hs-s-text-r-g-defining), use the relative pronoun “which” for a singular subject and “who” for a plural subject:
...
Avoid using “(s)” to express the possible plurality of a term unless it can be used simply, as it can overcomplicate a sentence. The plural form is usually sufficient to convey the meaning, for example:

*   “Ensure the samples are stored in suitable conditions.”

Alternatively, the phrase “one or more” can be used:

*   “Ensure that one or more samples are stored in suitable conditions.”  

If it is necessary to be precise and to include a term in both plural and singular form, ensure that the rest of the sentence is adapted appropriately, with verbs placed in brackets corresponding to noun endings in brackets. For example:

*   “Ensure the sample(s) is (are) stored in suitable conditions.”
...
| Use ‑**re** and not ‑er | calibre, centre, fibre, litre, metre\*, spectre, theatre  <br>\*except use meter for a measuring instrument |
...
| Use **“ll”** not “l” spellings of certain words | cancel – cancelled, cancelling  <br>label – labelled, labelling  <br>enrol – enrolled, enrolling (but: enrolment)  <br>fulfil – fulfilled, fulfilling (but: fulfilment)  <br>model – modelled, modelling  <br>signal – signalled, signalling  <br>travel – travelled, travelling, traveller |
| Use **‑ae**, **\-oe** and not ‑e spellings of certain words | aesthetic, anaemia, anaesthetic, archaeology, haematology, orthopaedics, paediatrics  <br>foetal, manoeuvre, oestrogen |
| Use the **‑e** spellings of certain words | acknowledgement, ageing, judgement\*  <br>\*except use judgment in a legal context |
| For nouns, use the suffix **‑ence** and not ‑ense | defence, licence, offence, pretence  <br>But note: defensive, offensive, pretension |
| Use different spellings for the noun and the verb forms of certain words | licence (noun) – to license (verb)  <br>practice (noun) – to practise (verb) |
| Use **programme** and not program\* | \*except use program for computer programs |
| Use **Petri** (dish) not petri or Pétri or pétri |     |
| Use **sulfur** and not sulphur  <br>Use **sulfate** and not sulphate  <br>Use **sulfide** and not sulphide | Reason: ISO documents follow the spelling used by the International Union of Pure and Applied Chemistry (IUPAC) in their periodic table of the elements (element 16): [iupac.org](https://iupac.org/what-we-do/periodic-table-of-elements/ "IUPAC - Periodic table of elements") |
...
As specified in [ISO/IEC Directives, Part 2, 2021, 8.3](https://www.iso.org/sites/directives/current/part2/index.xhtml#_idTextAnchor103 "ISO/IEC Directives, Part 2, 2021, 8.3"):
...
Avoid the use of Latin words as far as possible. Use [Plain English](#iso-hs-s-text-r-plain-english "ISO House Style - plain english") instead.

Do not italicize commonly used Latin expressions, e.g. a priori, in situ, in vitro.

Italicize Latin words used for scientific terms, e.g. species, bacteria, plants. For example, “This document describes a horizontal method for the detection of _Salmonella_ spp. in food”.
...
Codes for countries, dependencies, other areas of particular geopolitical interest and their subdivisions are specified by ISO 3166 (parts [1](https://www.iso.org/obp/ui/#iso:std:iso:3166:-1:ed-4:v1:en "ISO 3166-1:2020(en) Codes for the representation of names of countries and their subdivisions — Part 1: Country code"), [2](https://www.iso.org/obp/ui/#iso:std:iso:3166:-2:ed-4:v1:en "ISO 3166-2:2020(en) Codes for the representation of names of countries and their subdivisions — Part 2: Country subdivision code"), [3](https://www.iso.org/obp/ui/#iso:std:iso:3166:-3:ed-3:v1:en "ISO 3166-3:2020(en) Codes for the representation of names of countries and their subdivisions — Part 3: Code for formerly used names of countries")) and are available to view on the Online Browsing Platform: [www.iso.org/obp](https://www.iso.org/obp "obp"). Select “country codes” and “search” to see the full list.
...
Codes for countries’ currencies are specified by [ISO 4217](https://www.iso.org/obp/ui/#iso:std:iso:4217:ed-8:v1:en "ISO 4217:2015(en) Codes for the representation of currencies") and are available to download from the ISO 4217 Maintenance Agency: [www.currency-iso.org/en/home/tables/table-a1.html](https://www.currency-iso.org/en/home/tables/table-a1.html "Country code by ISO 4217").

Use the [ISO 4217](https://www.iso.org/obp/ui/#iso:std:iso:4217:ed-8:v1:en "ISO 4217:2015(en) Codes for the representation of currencies") codes rather than currency symbols.
...
Use lower case for general IT terms (e.g. “file format”, “key wrap”, “syntax”), see [Capitals.](#iso-hs-s-text-r-s-capitals "Capitals")

#### Conformity and conformity-related terms

The word “compliance” is used in connection with legislation and regulations, which are not generally mentioned in ISO documents. See [Legal statements](#iso-hs-s-text-r-s-legal "Legal statements").
...
ISO/CASCO, the _Committee on conformity assessment_, has produced definitions for conformity-related terminology, e.g. “competence” and “assessment”. If there is a need to define this kind of terminology in a standard, search the [Online Browsing Platform](https://www.iso.org/obp/ui/ "Online Browsing Platform") to find the CASCO definition to use as a source. Do not develop a new definition for the document. Contact CASCO at an early stage when developing a standard containing conformity assessment elements: [CASCO@iso.org](mailto:CASCO@iso.org)
...
[ISO/IEC Directives, Part 2, 2021, 8.6](https://www.iso.org/sites/directives/current/part2/index.xhtml#_idTextAnchor109 "ISO/IEC Directives, Part 2, 2021, 8.6"), requires that inclusive terminology be used wherever possible.

Guidance on the use of inclusive terminology in ISO and IEC documents and a list of non-inclusive terms and recommended alternatives are provided on [the ISO website](https://www.iso.org/resources/publicly-available-resources.html?t=1LSJG9ms7Qyjks_YM6YiW5Q_pyDJxl2UR4ZDkyWhbJ-diDNZWWuXsKerDxXDhj_T&view=documents#section-isodocuments-top "Inclusive terminology").

Feedback or questions concerning these resources can be sent to [inclusive@iso.org](mailto:inclusive@iso.org?subject=Inclusive%20terminology "Inclusive terminology")
...
In marketing material, documents that are thematically linked but are not a series and have different numbers are sometimes referred to as a “family of standards” or "suite of standards". For example, the ISO 9000 family includes ISO 9000, ISO 9001, ISO 10001, ISO 19011, etc.  

However, in technical documents such as International Standards, which need to be precise, the terms “family of standards” and "suite of standards" are too vague, unlike the term “series”, which represents one document split into a series of parts, e.g. ISO 10241‑1, ISO 10241‑2.

Use instead the following wording: “documents on \[subject area\] developed by \[ISO committee\]”. For additional clarification, a list of the relevant documents can be included in the Introduction, if appropriate. 

#### Standards

[ISO 3166-1:2020](/standard/72482.html)

Codes for the representation of names of countries and their subdivisions

Part 1: Country code

[ISO 3166-2:2020](/standard/72483.html)

Codes for the representation of names of countries and their subdivisions

Part 2: Country subdivision code

[ISO 3166-3:2020](/standard/72484.html)

Codes for the representation of names of countries and their subdivisions

Part 3: Code for formerly used names of countries

[ISO 4217:2015](/contents/data/standard/06/47/64758.html)

Codes for the representation of currencies

### Abbreviated terms, abbreviations and contractions
...
Do not use the term “abbreviations” in this context because this refers instead to shortened words, see [Abbreviations and contractions](#iso-hs-s-text-r-a-abbreviations "Abbreviation and contractions").

[ISO/IEC Directives, Part 2, 2021, 8.4](https://www.iso.org/sites/directives/current/part2/index.xhtml#_idTextAnchor105 "ISO/IEC Directives, Part 2, 2021, 8.4"), includes instructions on presenting abbreviated terms:
...
In terms and definitions, the full term is spelled out at the first use in each entry. This is because terms and definitions are available as standalone items on the [Online Browsing Platform](https://www.iso.org/obp/ui/ "Online Browsing Platform").
...
As specified in [ISO/IEC Directives, Part 2, 2021, 8.4](https://www.iso.org/sites/directives/current/part2/index.xhtml#_idTextAnchor105 "ISO/IEC Directives, Part 2, 2021, 8.4"):
...
Do not use capital letters for the full term unless it is a proper noun, see [Capitals](#iso-hs-s-text-r-s-capitals "Capitals").
...
A forward slash is often used in English to express “either or both” of two options. The meaning can be ambiguous, especially in translation to other languages where the “/” is not a recognized punctuation mark.

Avoid using a forward slash or the wording “and/or” in a document to avoid confusion and misapplication. Use the construction “either x or y, or both” instead.
...
In case of doubt, follow the spelling of the Oxford English Dictionary. For an online version, see [www.oxfordlearnersdictionaries.com](https://www.oxfordlearnersdictionaries.com).
...
| --- | --- |
| (a) increased value addition in natural resource-based industries | — industry, value added (constant 2000 USD)<br><br>— industry, value added (annual % growth)<br><br>— GDP per person employed (constant 1990 PPP USD)<br><br>— employment in industry (% of total employment) |
...
### Numbers, values and dates

#### General

The rules for the representation of numbers and values are given in [ISO/IEC Directives, Part 2, 2021, Clause 9](https://www.iso.org/sites/directives/current/part2/index.xhtml#_idTextAnchor111 "ISO/IEC Directives, Part 2, 2021, Clause 9").
...
Put the currency code in front of the amount.  Write “USD 100 million” rather than “USD 100 000 000” to avoid a string of zeros, except in tables.
